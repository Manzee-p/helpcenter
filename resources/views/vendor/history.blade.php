        ...
        <form method="GET" action="{{ route('vendor.history') }}" class="filter-body">
            ...
            <div class="fg" style="align-self:flex-end">
                ...
                <div class="view-switch">
                    <button type="button" class="vs-btn {{ request('view','list')==='list' ? 'active' : '' }}" onclick="setView('list')" title="List"><i class='bx bx-list-ul'></i></button>
                    <button type="button" class="vs-btn {{ request('view')==='grid' ? 'active' : '' }}" onclick="setView('grid')" title="Grid"><i class='bx bx-grid-alt'></i></button>
                </div>
