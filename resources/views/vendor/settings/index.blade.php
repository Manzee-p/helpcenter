            ...
            <div class="as-card-body">
                ...
                <div class="as-avatar-section">
                    ...
                    <div class="as-avatar-actions">
                        ...
                        @if($avatarUrl)
                        <form method="POST" action="{{ auth()->user()->role === 'vendor' ? route('vendor.settings.avatar.delete') : route('admin.settings.avatar.delete') }}" style="margin:0;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="as-btn red-outline" id="btnRemoveAvatar" onclick="return confirm('Hapus foto profil?')">
