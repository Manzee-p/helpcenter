...
// ==================== NOTIFICATIONS ====================
// ✅ FIX: pakai 'auth:sanctum,web' supaya bisa diakses dari
//    Blade (session cookie) DAN Vue/mobile (Bearer token)
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::middleware('role:admin')->prefix('admin')->group(function () {
        ...
        Route::prefix('status-board')->group(function () {
            ...
            Route::get('/',            [StatusBoardController::class, 'apiIndex']);
            Route::post('/',           [StatusBoardController::class, 'store']);
            Route::get('/{id}',        [StatusBoardController::class, 'show']);
...
Route::middleware('role:admin')->prefix('admin/settings')->group(function () {
    ...
    Route::middleware('role:vendor')->prefix('vendor')->group(function () {
        ...
        Route::delete('/avatar',          [VendorController::class, 'deleteAvatar']);
